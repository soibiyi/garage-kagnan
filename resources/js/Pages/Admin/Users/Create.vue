...
<template>
  <div class="max-w-3xl mx-auto mt-12 bg-white p-8 rounded-xl shadow-lg border-t-4" style="border-color: #C8102E;">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-bold" style="color: #1A1A1A;">Ajouter un Collaborateur / Rôle</h1>
      <Link :href="route('admin.users.index')" class="text-sm font-medium" style="color: #8A8D8F;">← Retour à la liste</Link>
    </div>

    <!-- Affichage global des erreurs de validation Inertia -->
    ...
    <form @submit.prevent="submit" class="space-y-6">
      ...
      <!-- Mot de passe -->
      <div>
        <label class="block text-sm font-semibold mb-2" style="color: #1A1A1A;">Mot de passe temporaire</label>
